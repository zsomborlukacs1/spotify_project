const translations = {
    en: {
      ...
      login: "Login",
      instructions_heading: "Top 10 Artists 🧑🏻‍🎨",
      instructions_paragraph: " Here you'll find your top artists in 3 different time intervals.Choose the one you like! 😀",
    ...
    hu: {
      ...
      discover: "Felfedezés",
      login: "Bejelentkezés",
      instructions_heading: "Top 10 Előadó 🎵",
      instructions_paragraph: "Itt található a kedvenc 10 előadód 3 különböző időintervallum alapján. Válaszd ki a neked tetszőt! 😀",
  ...
  function translatePage(language) {
    document.querySelector('.header-text').innerText = translations[language].top_artists_dasboard;
    ...
    document.querySelector('.inst-heading').innerHTML = translations[language].instructions_heading;
